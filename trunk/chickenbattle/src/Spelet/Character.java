...
public class Character {
	...
	public Character() {
		...
		charChill.setMaterial(new Material("s_texture", new TextureAttribute(modelTexture, 0, "a_texCoord0")));
		charDuck.setMaterial(new Material("s_texture", new TextureAttribute(modelTexture, 0, "a_texCoord0")));
		charDuckup.setMaterial(new Material("s_texture", new TextureAttribute(modelTexture, 0, "a_texCoord0")));
		charJump.setMaterial(new Material("s_texture", new TextureAttribute(modelTexture, 0, "a_texCoord0")));
		charLand.setMaterial(new Material("s_texture", new TextureAttribute(modelTexture, 0, "a_texCoord0")));
		charStrafeLeft.setMaterial(new Material("s_texture", new TextureAttribute(modelTexture, 0, "a_texCoord0")));
		charStrafeRight.setMaterial(new Material("s_texture", new TextureAttribute(modelTexture, 0, "a_texCoord0")));
